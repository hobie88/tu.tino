"""autogenerated by genmsg_py from Listened.msg. Do not edit."""
import roslib.message
import struct


class Listened(roslib.message.Message):
...
"""
  ...
  def serialize(self, buff):
    ...
    try:
      ...
      buff.write(struct.pack('<I%ss'%length, length, _x))
      _x = self
      buff.write(_struct_2d.pack(_x.total_score, _x.min_score))
      _x = self.all_score
      length = len(_x)
      buff.write(struct.pack('<I%ss'%length, length, _x))
  ...
  def deserialize(self, str):
    ...
    try:
      ...
      (_x.total_score, _x.min_score,) = _struct_2d.unpack(str[start:end])
      start = end
      end += 4
      (length,) = _struct_I.unpack(str[start:end])
      start = end
